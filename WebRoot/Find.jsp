...
<%String path="request.getContextPath()" ;
  ...
  <%
    ...
    <form action="Find.jsp" method = "post">
        <h3 align="center" style="font-size:30px">查询图书信息</h3>
        <td width="318"><input name="book" type="text" id="book"></td>
    ...
    <% 
    String BOOK = request.getParameter("book");
    rs=stat.executeQuery("select * from t_bookedito where id='"+BOOK+"'");
